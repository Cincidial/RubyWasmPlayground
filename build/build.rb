...
# Build output
atlas_meta_hash = { icon: { common_width: 64, common_height: 64 }, front: {} }
...
used_tiles.each do |tileset_key, v|
    ...
    atlas_meta_hash[tileset_key] = { common_width: 32, common_height: 32 }
    v.each_key do |k|
        next if k.zero? # Zero means transparent
...
File.write('build_temp/build_processed_data.json', JSON.generate(processed_data))
